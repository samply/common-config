...
public class ObjectFactory {
    ...
    private final static QName _Mainzelliste_QNAME = new QName("http://schema.samply.de/id-manager", "Mainzelliste");
    private final static QName _SplitDate_QNAME = new QName("http://schema.samply.de/id-manager", "SplitDate");
    private final static QName _IDManager_QNAME = new QName("http://schema.samply.de/id-manager", "ID-Manager");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.samply.common.config.idmanager
     * 
     */
