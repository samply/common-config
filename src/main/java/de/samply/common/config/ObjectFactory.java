...
public class ObjectFactory {
    ...
    private final static QName _OAuth2Provider_QNAME = new QName("http://schema.samply.de/config/OAuth2Provider", "oAuth2Provider");
    private final static QName _Postgresql_QNAME = new QName("http://schema.samply.de/common", "postgresql");
    private final static QName _Configuration_QNAME = new QName("http://schema.samply.de/common", "Configuration");
    private final static QName _OAuth2Client_QNAME = new QName("http://schema.samply.de/config/OAuth2Client", "oAuth2Client");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.samply.common.config
     * 
     */
    ...
    public JAXBElement<OAuth2Provider> createOAuth2Provider(OAuth2Provider value) {
        return new JAXBElement<OAuth2Provider>(_OAuth2Provider_QNAME, OAuth2Provider.class, null, value);
    }
