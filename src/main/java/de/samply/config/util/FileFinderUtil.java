...
public class FileFinderUtil {
   ...
   * @param fallback The fallback folder. The $fallback/(conf|classes) folders will be included in
   *     the search path. May be null.
   * @return the {@link java.io.File} handle.
   * @throws java.io.FileNotFoundException if file could not be found.
   */
  public static File findFile(String file, String prefix, String fallback)
   ...
   *
   * @param prefix The project prefix, e.g. "samply" or "osse"
   * @param fallbackRoot The fallback folder. The $fallback/(conf|classes) folders will be included
  ...
  public static List<String> getConfigurationDirs(String prefix, String fallbackRoot) {
    ...
    if (prefix != null) {
      ...
      target.add(System.getProperty("user.home") + File.separator + ".config" + File.separator
          + prefixLower + File.separator);
    ...
    if (fallbackRoot != null) {
      ...
      target.add(fallbackRoot + File.separator + "test-classes" + File.separator + "conf"
          + File.separator);
    } else {
