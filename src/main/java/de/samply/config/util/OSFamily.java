...
/**
 * The OS family describes the operating system family in an easier way than
 * "os.name" from the system properties.
 *
 */
public enum OSFamily {
     ...
     *
     * @return a {@link de.samply.config.util.OSFamily} object.
     */
